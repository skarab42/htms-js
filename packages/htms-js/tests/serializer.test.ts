...
describe('createHtmsSerializer', () => {
  it('should serialize a simple html file with [data-htms] attribute', async () => {
    ...
    expect(html).toMatchInlineSnapshot(`
      ...
      <script data-htms-remove-on-cleanup>"use strict";var htms=(()=>{var s=Object.defineProperty;var f=Object.getOwnPropertyDescriptor;var b=Object.getOwnPropertyNames;var M=Object.prototype.hasOwnProperty;var h=(e,t)=>{for(var r in t)s(e,r,{get:t[r],enumerable:!0})},C=(e,t,r,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of b(t))!M.call(e,n)&&n!==r&&s(e,n,{get:()=>t[n],enumerable:!(o=f(t,n))||o.enumerable});return e};var g=e=>C(s({},"__esModule",{value:!0}),e);var A={};h(A,{HTMLChunk:()=>m,cleanup:()=>y,commit:()=>p,parseCommitMode:()=>l,removeHtmsAttributes:()=>c,setup:()=>x,toFragment:()=>d});var k=["replace","content","append","prepend","before","after"],a="replace";function u(e){return k.includes(e)}function l(e){return u(e)?e:(console.error(\`[htms-chunk] unknown commit mode '\${e}', fallback to '\${a}'\`),a)}function d(e){let t=document.createElement("template");return t.innerHTML=e,t.content}function p(e,t,r){let o=d(t);switch(r){case"content":{e.replaceChildren(o),e.setAttribute("aria-busy","false");break}case"append":{e.append(o),e.setAttribute("aria-busy","false");break}case"prepend":{e.prepend(o),e.setAttribute("aria-busy","false");break}case"before":{e.before(o);break}case"after":{e.after(o);break}default:{e.replaceWith(o);break}}}function c(e){for(let t of e.attributes)/^(data-)?htms/.test(t.name)&&e.removeAttribute(t.name)}var m=class extends HTMLElement{connectedCallback(){let t=this.getAttribute("uuid"),r=this.getAttribute("commit"),o=this.getAttribute("partial");if(!t){console.error("[htms-chunk] missing 'uuid' attribute:",this);return}let n=\`[data-htms-uuid="\${t}"]\`,i=document.querySelector(n);if(!i){console.error(\`[htms-chunk] target element not found with selector '\${n}'\`);return}requestAnimationFrame(()=>{p(i,this.innerHTML,l(r)),(typeof o!="string"||o.trim()==="false")&&c(i),this.remove()})}};function x(){customElements.get("htms-chunk")||customElements.define("htms-chunk",m)}function y(){for(let e of document.querySelectorAll("[data-htms-remove-on-cleanup]"))e.remove();for(let e of document.querySelectorAll("[htms-module], [data-htms-module]"))c(e)}return g(A);})();
      </script>
